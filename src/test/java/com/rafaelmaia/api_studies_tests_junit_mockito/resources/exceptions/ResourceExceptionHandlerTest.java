...
class ResourceExceptionHandlerTest {
    ...
    void dataIntegrityViolationException() {
        ResponseEntity<StandardError> response = exceptionHandler.dataIntegrityViolationException(
                new DataIntegratyViolationException(EMAIL_ALREADY_REGISTERED_IN_THE_SYSTEM),
                new MockHttpServletRequest());
        ...
        assertEquals(ResponseEntity.class, response.getClass());
        assertEquals(StandardError.class, response.getBody().getClass());
        assertEquals(EMAIL_ALREADY_REGISTERED_IN_THE_SYSTEM, response.getBody().getError());
